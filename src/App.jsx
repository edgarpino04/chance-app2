...
const SORTEOS_RECIENTES = [
  {
    ...
    sorteoN: "3062", fecha: "08 de abril de 2026",
    premios: [
      { pos: "1er Premio", num: "4252", letras: "BBCD", serie: "17", folio: "6" },
      { pos: "2do Premio", num: "5459", letras: "", serie: "", folio: "" },
      { pos: "3er Premio", num: "3532", letras: "", serie: "", folio: "" },
    ],
    premioMayor: "$100,000",
    proximoISO: "2026-04-15T15:00:00",
    frecuencia: "Cada miércoles",
  },
  {
    tipo: "DOMINICAL", icon: "🌟", color: "#F4C430", bg: "rgba(244,196,48,.1)", border: "rgba(244,196,48,.28)",
    sorteoN: "5549", fecha: "05 de abril de 2026",
    premios: [
      { pos: "1er Premio", num: "5349", letras: "BAAB", serie: "8", folio: "13" },
      { pos: "2do Premio", num: "8952", letras: "", serie: "", folio: "" },
      { pos: "3er Premio", num: "2891", letras: "", serie: "", folio: "" },
    ],
    premioMayor: "$100,000",
    proximoISO: "2026-04-12T15:00:00",
  ...
  },
  {
    ...
    proximoISO: "2026-04-25T15:00:00",
    ...
    <div className="sc fu">
      ...
      <div className="tabs">
        {["resultados","historial","verificar"].map(t=>(
          <button key={t} className={`tab ${tab===t?"on":""}`} style={{textTransform:"capitalize"}} onClick={()=>setTab(t)}>{t}</button>
        ))}
      </div>
      ...
      {/* ── VERIFICAR ── */}
      {tab==="verificar"&&<>
        <div style={{background:"var(--bg2)",border:"1px solid var(--border)",borderRadius:16,padding:16,textAlign:"center",marginBottom:12}}>
          <div style={{fontSize:12,fontWeight:600,color:"var(--text)",marginBottom:1}}>Escanea el código de barras</div>
          <div style={{fontSize:10,color:"var(--muted)"}}>de tu billete o chance</div>
        ...
        <div className="row" style={{gap:7,marginBottom:10}}>
          <input className="inp" placeholder="Número (ej: 3561 o 07)" value={q} onChange={e=>setQ(e.target.value)} style={{flex:1}}/>
          <button className="btn-sm" onClick={()=>q.trim()&&setScanned(true)}>
            <Ic n="search" s={14} c="#08111F"/>
          </button>
        </div>
        {scanned&&(
          <div className="pop" style={{background:"linear-gradient(135deg,rgba(0,214,143,.1),rgba(0,214,143,.04))",border:"1px solid rgba(0,214,143,.28)",borderRadius:18,padding:20,textAlign:"center"}}>
            <div style={{fontSize:40,marginBottom:8}}>🏆</div>
            <div style={{fontFamily:"'Bebas Neue'",fontSize:32,color:"var(--green)",letterSpacing:4,marginBottom:3}}>¡GANADOR!</div>
            <div style={{fontWeight:800,fontSize:16,color:"var(--text)",marginBottom:2}}>Nº {q}</div>
            <div style={{fontSize:11,color:"var(--muted)",marginBottom:12}}>Miercolito Sorteo 3058 · 01 Abr 2026 · 1er Premio</div>
            <div style={{background:"rgba(8,17,31,.5)",borderRadius:11,padding:"9px 18px",display:"inline-block",marginBottom:14}}>
              <div style={{fontFamily:"'Bebas Neue'",fontSize:40,color:"var(--gold)",letterSpacing:3}}>$100,000</div>
            </div>
            <button className="btn" style={{width:"100%"}}>Ver cómo cobrar mi premio</button>
          </div>
        )}
      </>}
    </div>
